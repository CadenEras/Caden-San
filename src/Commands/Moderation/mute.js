    ...
    async run( message, args, client ) {
        try {
            ...
            if ( !muteRole ) {
                ...
                var defaultMuteRole = message.guild.roles.cache.find( ( role ) => role.name === "muted" )
            ...
            if ( member.roles.cache.some( ( role ) => role.name === "muted" ) || member.roles.cache.some( ( role ) => role.id === cMuteRole ) )
